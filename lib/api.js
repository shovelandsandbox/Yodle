...
Api.prototype.call = function(data, path, method) {
  return new Promise(function (_resolve, _reject) {
    ...
    var options = {
      hostname: global.applesauce.config.HOST ? global.applesauce.config.HOST : 'applesauce-staging@herokuapp.com',
      port: global.applesauce.config.PORT ? global.applesauce.config.PORT : 80,
      path: path + query,
      method: method,
      headers: {
